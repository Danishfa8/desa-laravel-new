                    ...
                    <div class="card-header">
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            ...
                            <div class="float-right">
                                <a href="{{ route('admin_desa.perangkat-desa.create') }}"
                                ...
                                <tbody>
                                    @foreach ($perangkatDesas as $perangkatDesa)
                                        <tr>
                                            ...
                                            <td>
                                                <form
                                                    action="{{ route('admin_desa.perangkat-desa.destroy', $perangkatDesa->id) }}"
                                                    method="POST">
                                                    <button type="button" class="btn btn-sm btn-primary"
                                                        ...
                                                        href="{{ route('admin_desa.perangkat-desa.edit', $perangkatDesa->id) }}"><i
