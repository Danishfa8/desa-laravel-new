                                ...
                                <tbody>
                                    @foreach ($pengeluarans as $pengeluaran)
                                        <tr>
                                            ...
                                            <td>
                                                <form
                                                    action="{{ route('superadmin.pengeluaran.destroy', $pengeluaran->id) }}"
                                                    method="POST">
                                                    <button type="button" class="btn btn-sm btn-primary"
                                                        data-bs-toggle="modal"
                                                        data-bs-target="#showModal{{ $pengeluaran->id }}">
                                                        <i class="las la-eye"></i> {{ __('Show') }}
                                                    </button>
                                                    <a class="btn btn-sm btn-success"
                                                        href="{{ route('superadmin.pengeluaran.edit', $pengeluaran->id) }}"><i
