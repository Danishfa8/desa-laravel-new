...
<head>
    ...
    <meta charset="utf-8" />
    <title><?php echo e($settingWebsite->title); ?></title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta content="<?php echo e($settingWebsite->description); ?>" name="description" />
    <meta content="Themesbrand" name="author" />
    <!-- App favicon -->
    <link rel="shortcut icon" href="<?php echo e($settingWebsite->favicon); ?>">
    ...
    <div id="layout-wrapper">
                    ...
                    <div class="d-flex">
                        ...
                        <div class="navbar-brand-box horizontal-logo">
                            <a href="index.html" class="logo logo-dark">
                                ...
                                <span class="logo-lg">
                                    <img src="<?php echo e(asset('assets/images/logo-dark.png')); ?>" alt=""
                                        height="17">
                                </span>
                            </a>
                            ...
                            <a href="index.html" class="logo logo-light">
                                ...
                                <span class="logo-lg">
                                    <img src="<?php echo e(asset('assets/images/logo-light.png')); ?>" alt=""
                                        height="17">
                                </span>
                            </a>
                        </div>
                            ...
                            <button type="button" class="btn material-shadow-none" id="page-header-user-dropdown"
                                ...
                                <span class="d-flex align-items-center">
                                    ...
                                    <span class="text-start ms-xl-2">
                                        ...
                                        <span
                                            class="d-none d-xl-block ms-1 fs-12 user-name-sub-text"><?php echo e(Auth::user()->email); ?></span>
                                    </span>
                                </span>
                            </button>
        ...
        <div class="main-content">
            <div class="page-content">
                ...
                <?php echo $__env->make('layouts.partials.javascript', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                <footer class="footer">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                </script> © Starterkit SangkalaTech.
                            </div>
                            <div class="col-sm-6">
...
<?php /**PATH C:\Users\Acer\Documents\PEMROGRAMMAN\DBS\BPS\desa-laravel-new\resources\views/layouts/app.blade.php ENDPATH**/ ?>