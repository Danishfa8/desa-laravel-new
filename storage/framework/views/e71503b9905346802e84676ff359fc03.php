    ...
    <div id="vision-mission-section" class="bg-white rounded-lg shadow-md p-6 mb-6">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div class="order-2 lg:order-1">
                <img src="<?php echo e(asset('assets/images/kantorbbs.jpg')); ?>" alt="Kantor Pemerintahan"
        ...
        <div class="grid grid-cols-1 lg:grid-cols-4 gap-6">
            ...
            <div class="lg:col-span-1">
                <div class="bg-gray-200 rounded-lg h-48 flex items-center justify-center">
                    <img src="<?php echo e(asset('assets/images/petabbs.png')); ?>" alt="Peta Wilayah"
            ...
            <div class="lg:col-span-3">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div class="text-center p-4 bg-gray-50 rounded-lg">
                        ...
                        <p class="text-2xl font-bold text-gray-800"><?php echo e($kecamatans->count()); ?> Kecamatan</p>
                    </div>
                    ...
                    <div class="text-center p-4 bg-gray-50 rounded-lg">
                        ...
                        <p class="text-2xl font-bold text-gray-800"><?php echo e($desas->count()); ?> Desa</p>
                    </div>
                </div>
            </div>
        </div>
    </div>
    <?php echo $__env->make('web.partials.section-content', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    </main>

    <?php echo $__env->make('web.partials.javascript', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<?php $__env->stopSection(); ?>




<?php echo $__env->make('layouts.appweb2', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Acer\Documents\PEMROGRAMMAN\DBS\BPS\desa-laravel-new\resources\views/web/profile.blade.php ENDPATH**/ ?>