    ...
    <script>
        $(document).ready(function() {
            ...
            function loadDataByCategory(year, category) {
                ...
                $.ajax({
                    url: '<?php echo e(route('data.getByCategory')); ?>',
                    type: 'POST',
                    data: {
                        year: year,
                        category: category,
            ...
            function loadDesaByKecamatan(kecamatan_id) {
                $.ajax({
                    url: '<?php echo e(route('data.getDesaByKecamatan')); ?>',
                    type: 'POST',
                    data: {
            ...
            function loadResult(year, category, data_type, kecamatan_id, desa_id) {
                ...
                $.ajax({
                    url: '<?php echo e(route('data.getResult')); ?>',
                    type: 'POST',
                    data: {
                        year: year,
                        category: category,
...
<?php echo $__env->make('layouts.appweb2', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Acer\Documents\PEMROGRAMMAN\DBS\BPS\desa-laravel-new\resources\views/web/data-angka.blade.php ENDPATH**/ ?>