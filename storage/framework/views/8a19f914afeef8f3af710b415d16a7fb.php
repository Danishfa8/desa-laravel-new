<footer class="w-full bg-blue-900 text-white py-6 border-t border-blue-800 mt-auto">
   <div class="container mx-auto px-4">
      <div class="flex flex-col md:flex-row md:justify-between md:items-start gap-6">
         ...
         <div class="md:w-1/3">
            <div class="flex items-start space-x-3 mb-3">
               <img src="<?php echo e(asset('assets/images/Logo-brebes.png')); ?>" alt="Logo Kabupaten Brebes" class="w-12 h-12 object-contain" width="48" height="48" />
      ...
      <div class="text-center text-xs text-gray-300">
         <p>&copy; <?php echo e(date('Y')); ?> Desa Cantik Brebes. All rights reserved.</p>
         <p class="mt-1">Disclaimer: Data yang disajikan adalah untuk keperluan informasi dan dokumentasi.</p>
      </div>
   </div>
</footer>
<?php /**PATH C:\Users\Acer\Documents\PEMROGRAMMAN\DBS\BPS\desa-laravel-new\resources\views/layouts/footer.blade.php ENDPATH**/ ?>