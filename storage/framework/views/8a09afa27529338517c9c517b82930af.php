                    ...
                    <div class="card-header">
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            ...
                            <div class="float-right">
                                <a href="<?php echo e(route('superadmin.pendidikan-desa.create')); ?>"
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $pendidikanDesas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pendidikanDesa): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td>
                                                <form
                                                    action="<?php echo e(route('superadmin.pendidikan-desa.destroy', $pendidikanDesa->id)); ?>"
                                                    method="POST">
                                                    <button type="button" class="btn btn-sm btn-primary"
                                                        data-bs-toggle="modal"
                                                        data-bs-target="#showModal<?php echo e($pendidikanDesa->id); ?>">
                                                        <i class="las la-eye"></i> <?php echo e(__('Show')); ?>

                                                    </button>
                                                    <a class="btn btn-sm btn-success"
                                                        href="<?php echo e(route('superadmin.pendidikan-desa.edit', $pendidikanDesa->id)); ?>"><i
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Acer\Documents\PEMROGRAMMAN\DBS\BPS\desa-laravel-new\resources\views/superadmin/pendidikan-desa/index.blade.php ENDPATH**/ ?>