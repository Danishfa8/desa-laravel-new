                                ...
                                <tbody>
                                    <?php $__currentLoopData = $pendidikanDesas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pendidikanDesa): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td><img src="<?php echo e(asset('storage/foto_pendidikan/' . $pendidikanDesa->foto)); ?>"
                                                    alt="Pendidikan Desa"
...
<?php endif; ?>
                                                <?php if (isset($component)) { $__componentOriginala7843cb3d57b9ef6c06919b700b0e937 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginala7843cb3d57b9ef6c06919b700b0e937 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.pendidikan.modal-pendidikan','data' => ['item' => $pendidikanDesa]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('pendidikan.modal-pendidikan'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
...
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginala7843cb3d57b9ef6c06919b700b0e937)): ?>
<?php $attributes = $__attributesOriginala7843cb3d57b9ef6c06919b700b0e937; ?>
<?php unset($__attributesOriginala7843cb3d57b9ef6c06919b700b0e937); ?>
<?php endif; ?>
<?php if (isset($__componentOriginala7843cb3d57b9ef6c06919b700b0e937)): ?>
<?php $component = $__componentOriginala7843cb3d57b9ef6c06919b700b0e937; ?>
<?php unset($__componentOriginala7843cb3d57b9ef6c06919b700b0e937); ?>
<?php endif; ?>
                                        </tr>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Acer\Documents\PEMROGRAMMAN\DBS\BPS\desa-laravel-new\resources\views/admin_desa/pendidikan-desa/index.blade.php ENDPATH**/ ?>