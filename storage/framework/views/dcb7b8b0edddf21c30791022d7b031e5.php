<div id="desa-content" class="hidden">
    <!-- Navbar Tabs -->
    <nav class="mt-6 bg-white shadow-md rounded-lg p-4 border border-gray-200">
        <ul class="flex flex-wrap justify-center gap-4 border-b">
            <li><button
                    class="nav-button active cursor-pointer px-4 py-2 text-gray-700 font-semibold relative transition duration-300 border-b-2 border-transparent hover:text-blue-700 hover:border-orange-500"
...
<?php /**PATH C:\Users\Acer\Documents\PEMROGRAMMAN\DBS\BPS\desa-laravel-new\resources\views/web/partials/section-content.blade.php ENDPATH**/ ?>