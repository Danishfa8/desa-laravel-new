...
class Bumde extends Model
{
     ...
     */
    protected $fillable = ['desa_id', 'rt_rw_desa_id', 'nama_bumdes', 'deskripsi', 'created_by', 'updated_by', 'status', 'reject_reason', 'approved_by', 'approved_at'];
