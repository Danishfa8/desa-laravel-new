...
class SaranaPendukungKesehatanDesaController extends Controller
{
    ...
    public function create(): View
    {
        ...
        return view('admin_desa.sarana-pendukung-kesehatan-desa.create', compact('saranaPendukungKesehatanDesa', 'desas'));
    }
    ...
    public function edit($id): View
    {
        ...
        return view('admin_desa.sarana-pendukung-kesehatan-desa.edit', compact('saranaPendukungKesehatanDesa', 'desas'));
    }
