...
class LpmdkController extends Controller
{
    ...
    public function index(Request $request): View
    {
        ...
        return view('admin_desa.lpmdk.index', compact('lpmdks'))
    ...
    public function create(): View
    {
        ...
        return view('admin_desa.lpmdk.create', compact('lpmdk', 'desas'));
    }
    ...
    public function store(LpmdkRequest $request): RedirectResponse
    {
        ...
        return Redirect::route('admin_desa.lpmdk.index')
    ...
    public function show($id): View
    {
        ...
        return view('admin_desa.lpmdk.show', compact('lpmdk'));
    }
    ...
    public function edit($id): View
    {
        ...
        return view('admin_desa.lpmdk.edit', compact('lpmdk', 'desas'));
    }
