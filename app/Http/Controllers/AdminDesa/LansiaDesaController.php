...
class LansiaDesaController extends Controller
{
    ...
    public function index(Request $request): View
    {
        ...
        return view('admin_desa.lansia-desa.index', compact('lansiaDesas'))
    ...
    public function create(): View
    {
        ...
        return view('admin_desa.lansia-desa.create', compact('lansiaDesa', 'desas'));
    }
    ...
    public function store(LansiaDesaRequest $request): RedirectResponse
    {
        ...
        return Redirect::route('admin_desa.lansia-desa.index')
    ...
    public function show($id): View
    {
        ...
        return view('admin_desa.lansia-desa.show', compact('lansiaDesa'));
    }
    ...
    public function edit($id): View
    {
        ...
        return view('admin_desa.lansia-desa.edit', compact('lansiaDesa', 'desas'));
    }
