...
class SaranaKesehatanDesaController extends Controller
{
    ...
    public function create(): View
    {
        ...
        return view('admin_desa.sarana-kesehatan-desa.create', compact('saranaKesehatanDesa', 'desas'));
    }
    ...
    public function edit($id): View
    {
        ...
        return view('admin_desa.sarana-kesehatan-desa.edit', compact('saranaKesehatanDesa'));
    }
