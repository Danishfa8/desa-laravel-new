...
class RtRwDesaController extends Controller
{
    ...
    public function index(Request $request): View
    {
        ...
        return view('admin_desa.rt-rw-desa.index', compact('rtRwDesas'))
    ...
    public function create(): View
    {
        ...
        return view('admin_desa.rt-rw-desa.create', compact('rtRwDesa', 'desas'));
    }
    ...
    public function store(RtRwDesaRequest $request): RedirectResponse
    {
        ...
        return Redirect::route('admin_desa.rt-rw-desa.index')
    ...
    public function show($id): View
    {
        ...
        return view('admin_desa.rt-rw-desa.show', compact('rtRwDesa'));
    }
    ...
    public function edit($id): View
    {
        ...
        return view('admin_desa.rt-rw-desa.edit', compact('rtRwDesa', 'desas'));
    }
