...
class PkkDesaController extends Controller
{
    ...
    public function index(Request $request): View
    {
        ...
        return view('admin_desa.pkk-desa.index', compact('pkkDesas'))
    ...
    public function create(): View
    {
        ...
        return view('admin_desa.pkk-desa.create', compact('pkkDesa', 'desas'));
    }
    ...
    public function store(PkkDesaRequest $request): RedirectResponse
    {
        ...
        return Redirect::route('admin_desa.pkk-desa.index')
    ...
    public function show($id): View
    {
        ...
        return view('admin_desa.pkk-desa.show', compact('pkkDesa'));
    }
    ...
    public function edit($id): View
    {
        ...
        return view('admin_desa.pkk-desa.edit', compact('pkkDesa', 'desas'));
    }
