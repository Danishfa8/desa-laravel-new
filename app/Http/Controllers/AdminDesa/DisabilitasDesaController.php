...
class DisabilitasDesaController extends Controller
{
    ...
    public function index(Request $request): View
    {
        ...
        return view('admin_desa.disabilitas-desa.index', compact('disabilitasDesas'))
    ...
    public function create(): View
    {
        ...
        return view('admin_desa.disabilitas-desa.create', compact('disabilitasDesa', 'desas'));
    }
    ...
    public function store(DisabilitasDesaRequest $request): RedirectResponse
    {
        ...
        return Redirect::route('admin_desa.disabilitas-desa.index')
    ...
    public function show($id): View
    {
        ...
        return view('admin_desa.disabilitas-desa.show', compact('disabilitasDesa'));
    }
    ...
    public function edit($id): View
    {
        ...
        return view('admin_desa.disabilitas-desa.edit', compact('disabilitasDesa', 'desas'));
    }
