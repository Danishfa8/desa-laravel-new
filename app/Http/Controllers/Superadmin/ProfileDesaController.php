...
class ProfileDesaController extends Controller
{
    ...
    public function index(Request $request): View
    {
        ...
        return view('superadmin.desa.profile-desa.index', compact('profileDesas'))
    ...
    public function create($desa_id): View
    {
        ...
        return view('superadmin.desa.profile-desa.create', compact('profileDesa'));
    }
    ...
    public function store(ProfileDesaRequest $request): RedirectResponse
    {
        ...
        return Redirect::route('superadmin.desas.index')
    ...
    public function show($id): View
    {
        ...
        return view('superadmin.desa.profile-desa.show', compact('profileDesa'));
    }
    ...
    public function edit($id): View
    {
        ...
        return view('superadmin.desa.profile-desa.edit', compact('profileDesa'));
    }
    ...
    public function update(ProfileDesaRequest $request, ProfileDesa $profileDesa): RedirectResponse
    {
        ...
        return Redirect::route('superadmin.profile-desas.index')
