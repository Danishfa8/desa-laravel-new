...
class PendapatanDesaController extends Controller
{
    ...
    public function index(Request $request): View
    {
        ...
        return view('superadmin.pendapatan-desas.index', compact('pendapatanDesas'))
    ...
    public function create(): View
    {
        ...
        return view('superadmin.pendapatan-desas.create', compact('pendapatanDesa', 'desas'));
    }
    ...
    public function store(PendapatanDesaRequest $request): RedirectResponse
    {
        ...
        return Redirect::route('superadmin.pendapatan-desas.index')
    ...
    public function show($id): View
    {
        ...
        return view('superadmin.pendapatan-desas.show', compact('pendapatanDesa'));
    }
    ...
    public function edit($id): View
    {
        ...
        return view('superadmin.pendapatan-desas.edit', compact('pendapatanDesa'));
    }
