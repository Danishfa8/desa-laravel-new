...
class PengeluaranController extends Controller
{
    ...
    public function index(Request $request): View
    {
        ...
        return view('superadmin.pengeluaran.index', compact('pengeluarans'))
    ...
    public function create(): View
    {
        ...
        return view('superadmin.pengeluaran.create', compact('pengeluaran', 'desas'));
    }
    ...
    public function show($id): View
    {
        ...
        return view('superadmin.pengeluaran.show', compact('pengeluaran'));
    }
    ...
    public function edit($id): View
    {
        ...
        return view('superadmin.pengeluaran.edit', compact('pengeluaran', 'desas'));
    }
