...
class KerawananSosialDesaController extends Controller
{
    ...
    public function create(): View
    {
        ...
        return view('superadmin.kerawanan-sosial-desa.create', compact('kerawananSosialDesa', 'desas'));
    }
    ...
    public function edit($id): View
    {
        ...
        return view('superadmin.kerawanan-sosial-desa.edit', compact('kerawananSosialDesa', 'desas'));
    }
