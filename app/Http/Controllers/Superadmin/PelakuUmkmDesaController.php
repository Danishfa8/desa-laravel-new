...
class PelakuUmkmDesaController extends Controller
{
    ...
    public function index(Request $request): View
    {
        ...
        return view('superadmin.pelaku-umkm-desa.index', compact('pelakuUmkmDesas'))
    ...
    public function create(): View
    {
        ...
        return view('superadmin.pelaku-umkm-desa.create', compact('pelakuUmkmDesa', 'desas'));
    }
    ...
    public function store(PelakuUmkmDesaRequest $request): RedirectResponse
    {
        ...
        return Redirect::route('superadmin.pelaku-umkm-desa.index')
    ...
    public function show($id): View
    {
        ...
        return view('superadmin.pelaku-umkm-desa.show', compact('pelakuUmkmDesa'));
    }
    ...
    public function edit($id): View
    {
        ...
        return view('superadmin.pelaku-umkm-desa.edit', compact('pelakuUmkmDesa', 'desas'));
    }
