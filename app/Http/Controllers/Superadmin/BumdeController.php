...
class BumdeController extends Controller
{
    ...
    public function index(Request $request): View
    {
        ...
        return view('superadmin.bumdes.index', compact('bumdes'))
    ...
    public function create(): View
    {
        ...
        return view('superadmin.bumdes.create', compact('bumde', 'desas'));
    }
    ...
    public function store(BumdeRequest $request): RedirectResponse
    {
        ...
        return Redirect::route('superadmin.bumdes.index')
    ...
    public function show($id): View
    {
        ...
        return view('superadmin.bumdes.show', compact('bumde'));
    }
    ...
    public function edit($id): View
    {
        $bumde = Bumde::find($id);
        $desas = Desa::all();
        return view('superadmin.bumdes.edit', compact('bumde', 'desas'));
    }
