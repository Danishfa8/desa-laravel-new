...
class PerangkatDesaController extends Controller
{
    ...
    public function index(Request $request): View
    {
        ...
        return view('superadmin.perangkat-desa.index', compact('perangkatDesas'))
    ...
    public function create(): View
    {
        ...
        return view('superadmin.perangkat-desa.create', compact('perangkatDesa', 'desas'));
    }
    ...
    public function show($id): View
    {
        ...
        return view('superadmin.perangkat-desa.show', compact('perangkatDesa'));
    }
    ...
    public function edit($id): View
    {
        ...
        return view('superadmin.perangkat-desa.edit', compact('perangkatDesa'));
    }
    ...
    public function update(PerangkatDesaRequest $request, PerangkatDesa $perangkatDesa): RedirectResponse
    {
        ...
        return Redirect::route('superadmin.perangkat-desa.index')
