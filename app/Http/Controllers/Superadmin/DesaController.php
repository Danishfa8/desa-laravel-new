...
class DesaController extends Controller
{
    ...
    public function index(Request $request): View
    {
        ...
        return view('superadmin.desa.index', compact('desas'))
    ...
    public function create(): View
    {
        ...
        return view('superadmin.desa.create', compact('desa', 'kecamatans'));
    }
    ...
    public function show($id): View
    {
        ...
        return view('superadmin.desa.show', compact('desa'));
    }
    ...
    public function edit($id): View
    {
        ...
        return view('superadmin.desa.edit', compact('desa', 'desas'));
    }
