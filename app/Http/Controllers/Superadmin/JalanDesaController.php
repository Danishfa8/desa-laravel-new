...
class JalanDesaController extends Controller
{
    ...
    public function index(Request $request): View
    {
        ...
        return view('superadmin.jalan-desa.index', compact('jalanDesas'))
    ...
    public function create(): View
    {
        ...
        return view('superadmin.jalan-desa.create', compact('jalanDesa', 'desas'));
    }
    ...
    public function store(JalanDesaRequest $request): RedirectResponse
    {
        ...
        return Redirect::route('superadmin.jalan-desa.index')
    ...
    public function show($id): View
    {
        ...
        return view('superadmin.jalan-desa.show', compact('jalanDesa'));
    }
    ...
    public function edit($id): View
    {
        ...
        return view('superadmin.jalan-desa.edit', compact('jalanDesa', 'desas'));
    }
