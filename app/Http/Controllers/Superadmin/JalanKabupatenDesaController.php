...
class JalanKabupatenDesaController extends Controller
{
    ...
    public function index(Request $request): View
    {
        ...
        return view('superadmin.jalan-kabupaten-desa.index', compact('jalanKabupatenDesas'))
    ...
    public function create(): View
    {
        ...
        return view('superadmin.jalan-kabupaten-desa.create', compact('jalanKabupatenDesa', 'desas'));
    }
    ...
    public function store(JalanKabupatenDesaRequest $request): RedirectResponse
    {
        ...
        return Redirect::route('superadmin.jalan-kabupaten-desa.index')
    ...
    public function show($id): View
    {
        ...
        return view('superadmin.jalan-kabupaten-desa.show', compact('jalanKabupatenDesa'));
    }
    ...
    public function edit($id): View
    {
        ...
        return view('superadmin.jalan-kabupaten-desa.edit', compact('jalanKabupatenDesa', 'desas'));
    }
