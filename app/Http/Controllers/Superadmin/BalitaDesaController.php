...
class BalitaDesaController extends Controller
{
    ...
    public function index(Request $request): View
    {
        ...
        return view('superadmin.balita-desa.index', compact('balitaDesas'))
    ...
    public function create(): View
    {
        ...
        return view('superadmin.balita-desa.create', compact('balitaDesa', 'desas'));
    }
    ...
    public function store(BalitaDesaRequest $request): RedirectResponse
    {
        ...
        return Redirect::route('superadmin.balita-desa.index')
    ...
    public function show($id): View
    {
        ...
        return view('superadmin.balita-desa.show', compact('balitaDesa'));
    }
    ...
    public function edit($id): View
    {
        ...
        return view('superadmin.balita-desa.edit', compact('balitaDesa', 'desa'));
    }
