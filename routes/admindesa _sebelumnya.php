...
Route::middleware(['auth', 'role:admin_desa'])->group(function () {
    Route::prefix('admin_desa')->name('admin_desa.')->group(function () {
        ...
        Route::patch('jembatan-desa/{id}/ajukan', [JembatanDesaController::class, 'ajukan'])->name('admin_desa.universal.ajukan');
    //     Route::post('jembatan-desa/{id}/ajukan', [JembatanDesaController::class, 'ajukan'])
    // ->name('jembatan-desa.ajukan');
